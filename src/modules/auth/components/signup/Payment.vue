      ...
      <form class="padding-m" @keyup.enter.prevent="validateForm" novalidate>
        ...
        <div class="input-group">
          ...
          <div class="input-icon">
            <AppInput name="cardNumber" class="input input-m input--primary" placeholder="Card Number" maxlength="19" v-model="cardNumber" :options="cardOptions"></AppInput>
        ...
        <div class="input-group">
          ...
          <div class="input-icon">
            <AppInput name="expirationDate" class="input input-m input--primary" placeholder="MM/YYYY" maxlength="7" v-model="expirationDate" :options="{ date: true, datePattern: ['m', 'Y'] }"></AppInput>
        ...
        <div class="input-group">
          ...
          <div class="input-icon">
            <AppInput name="securityCode" class="input input-m input--primary" placeholder="123" maxlength="3" v-model="securityCode"></AppInput>
            <i class="icon-lock"></i>
          </div>
        </div>

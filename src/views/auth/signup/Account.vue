      ...
      <form class="padding-m" novalidate>
        ...
        <div class="input-group">
          ...
          <div class="input-icon">
            <app-input name="fullName" v-model="fullName" class="input input-m input--primary" placeholder="Full name"></app-input>
            <i class="icon-user"></i>
          </div>
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
          ...
          <div class="input-icon">
            <app-input name="company" class="input input-m input--primary" placeholder="Company name" v-model="company"></app-input>
